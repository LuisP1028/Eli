...
# -------------------- Configuration --------------------
####### Eli is a legacy model.
# ['High', 'Low', 'Close', 'agg_buy_sell_ratio']

# Paths
DATA_FILE_PATH = "C:/Users/Chopp/Desktop/3.csv"  # Replace with your actual file path
BEST_HYPERPARAMS_FILE = 'configs/eli_hyperparameters.json'
TRAINED_MODEL_FILE = 'models/eli.keras'  # Updated file extension to .keras
PLOT_OUTPUT_FILE = 'plots/model_performance.png'
...
required_features = ['High', 'Low', 'Close', 'agg_buy_sell_ratio'] ###
...
def build_lstm_model(hp, forecast_horizon, num_features):
    ...
    lookback = hp.Int('lookback', min_value=1, max_value=30, step=1)
